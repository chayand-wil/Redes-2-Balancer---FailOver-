...
grep -q "101[[:space:]]ISP1_TABLES" /etc/iproute2/rt_tables || echo "101 ISP1_TABLES" | sudo tee -a /etc/iproute2/rt_tables
grep -q "102[[:space:]]ISP2_TABLES" /etc/iproute2/rt_tables || echo "102 ISP2_TABLES" | sudo tee -a /etc/iproute2/rt_tables
...
ip route add 11.11.11.0/30 dev eno1 src 11.11.11.2 table ISP1_TABLES && echo "Ruta de red local 11.11.11.0/30 establecidas."
...
ip route add 11.11.12.0/30 dev enx00e04c36035e src 11.11.12.2 table ISP2_TABLES && echo "Ruta de red local 11.11.12.0/30 establecidas."
...
#nat para  PROXY
iptables -t nat -A POSTROUTING -o enx00e04c360357 -j MASQUERADE
...
# Eliminar reglas previas si existen (no error si no existen)
